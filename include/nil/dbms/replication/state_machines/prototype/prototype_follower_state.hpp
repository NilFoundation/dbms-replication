...
namespace nil::dbms::replication::replicated_state::prototype {
    struct prototype_follower_state : ireplicated_follower_state<prototype_state>,
                                      std::enable_shared_from_this<prototype_follower_state> {
        explicit prototype_follower_state(std::unique_ptr<prototype_core>,
    ...
    private:
        global_log_identifier const _logIdentifier;
        std::shared_ptr<iprototype_network_interface> const _networkInterface;
        Guarded<std::unique_ptr<prototype_core>, basics::UnshackledMutex> _guardedData;
    };
}    // namespace nil::dbms::replication::replicated_state::prototype
