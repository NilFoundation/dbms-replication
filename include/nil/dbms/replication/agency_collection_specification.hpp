...
DECLARE_HASH_FOR_IDENTIFIER(nil::dbms::replication::agency::collection_group_id)
DECLARE_EQUAL_FOR_IDENTIFIER(nil::dbms::replication::agency::collection_group_id)
