...
namespace nil::dbms {
    ...
    template<>
    struct nil::dbms::velocypack::Extractor<replication::replicated_state::state_generation> {
        static auto extract(velocypack::Slice slice) -> replication::replicated_state::state_generation {
            return replication::replicated_state::state_generation {slice.getNumericValue<std::uint64_t>()};
        }
    };
}    // namespace nil::dbms
