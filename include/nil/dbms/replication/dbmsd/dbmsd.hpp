...
namespace nil::dbms {
    ...
    namespace replication::replicated_state {
...
using DbmsdFeatures = TypeList<
    ...
    replication::replicated_state::replicated_state_app_feature,
    replication::replicated_state::black_hole::BlackHoleStateMachineFeature,
    replication::replicated_state::prototype::prototype_state_machine_feature,
    replication::replicated_state::document::DocumentStateMachineFeature,
    Bitcoin
>;    // clang-format on
