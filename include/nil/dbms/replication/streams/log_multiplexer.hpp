...
#include "stream_specification.hpp"
#include "streams.hpp"
...
namespace nil::dbms::replication::streams {
    ...
    struct log_multiplexer_stream_dispatcher : std::enable_shared_from_this<Self>,
    ...
    struct log_demultiplexer : log_multiplexer_stream_dispatcher<log_demultiplexer<Spec>, Spec, Stream> {
        ...
        static std::shared_ptr<log_demultiplexer>
            construct(std::shared_ptr<nil::dbms::replication::replicated_log::ilog_participant>);
    ...
    struct log_multiplexer : log_multiplexer_stream_dispatcher<log_multiplexer<Spec>, Spec, producer_stream> {
        static std::shared_ptr<log_multiplexer>
            construct(std::shared_ptr<nil::dbms::replication::replicated_log::ilog_leader> leader);
