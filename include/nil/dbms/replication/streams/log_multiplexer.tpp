...
#include "multiplexed_values.hpp"
#include "stream_information_block.hpp"
#include "streams.hpp"
#include "stream_information_block.tpp"
#include "streams.tpp"
...
namespace nil::dbms::replication::streams {
    ...
    struct log_multiplexer_implementation_base {
        ...
        auto wait_for_iterator_internal(log_index first)
            -> futures::Future<std::unique_ptr<typed_log_range_iterator<E>>> {
        ...
        struct multiplexer_data<stream_descriptor_set<Descriptors...>> {
            ...
            auto get_change_leader_resolve_set(std::exception_ptr ptr) {
                return std::make_tuple(std::make_pair(
                    std::move(get_block_for_descriptor<Descriptors>()._waitForQueue),
    ...
    struct log_multiplexer_implementation
        : log_multiplexer<Spec>,
          ...
          log_multiplexer_implementation_base<log_multiplexer_implementation<Spec>, Spec,
                                              nil::dbms::replication::streams::producer_stream> {
        ...
        auto insertInternalDeferred(T const &t) -> std::pair<log_index, deferred_action> {
            ...
            return std::make_pair(index, deferred_action([interface_ = _interface]() noexcept {
...
#pragma warning(pop)
    ...
    template<typename Spec>
    auto log_multiplexer<Spec>::construct(std::shared_ptr<nil::dbms::replication::replicated_log::ilog_leader> leader)
