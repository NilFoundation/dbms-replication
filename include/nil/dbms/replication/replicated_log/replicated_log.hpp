...
namespace nil::dbms::replication::replicated_log {
     ...
     * atomically.
     *
     * @note This class is an ABI supposed to be exposed by a plugin. This class
     * incapsulates the overall protocol behaviour including cluster leader election.
     */
