...
namespace nil::dbms::replication::replicated_log {
    ...
    public:
        ...
        static auto construct(logger_context const &, std::shared_ptr<replicated_log_metrics> logMetrics,
                              ParticipantId id, std::unique_ptr<log_core> logCore, log_term term,
                              std::optional<ParticipantId> leaderId) -> std::shared_ptr<log_follower>;
