...
namespace nil::dbms::replication::state {
    ...
    namespace prototype {
        ...
        struct iprototype_leader_interface {
            ...
            virtual auto get_snapshot(global_log_identifier const &log_id, log_index waitForIndex)
        ...
        struct iprototype_storage_interface {
            ...
            virtual auto put(global_log_identifier const &log_id, prototype_dump dump) -> Result = 0;
            virtual auto get(global_log_identifier const &log_id) -> ResultT<prototype_dump> = 0;
        };
        ...
        struct prototype_factory {
            ...
            auto construct_follower(std::unique_ptr<prototype_core> core) -> std::shared_ptr<prototype_follower_state>;
            auto construct_leader(std::unique_ptr<prototype_core> core) -> std::shared_ptr<prototype_leader_state>;
            auto construct_core(global_log_identifier const &) -> std::unique_ptr<prototype_core>;
    ...
    extern template struct state::ReplicatedState<prototype::prototype_state>;
}    // namespace nil::dbms::replication::state
