...
namespace nil::dbms::replication::state::prototype {
    ...
    struct prototype_dump {
        ...
        void to_velocy_pack(velocypack::Builder &);
        static auto from_velocy_pack(velocypack::Slice) -> prototype_dump;
    };
    ...
    struct prototype_core {
        ...
        explicit prototype_core(global_log_identifier log_id, logger_context loggerContext,
        ...
        auto get_read_state() -> StorageType;
        void apply_to_ongoing_state(log_index, prototype_log_entry const &);

        [[nodiscard]] auto get_last_persisted_index() const noexcept -> log_index const &;
        [[nodiscard]] auto getlog_id() const noexcept -> global_log_identifier const &;
