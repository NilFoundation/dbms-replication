        ...
        namespace replication {
            ...
            namespace state {
                ...
                protected:
                     ...
                     */
                    virtual auto apply_entries(std::unique_ptr <EntryIterator>)
                     ...
                     */
                    virtual auto acquireSnapshot(ParticipantId const &leader, log_index localCommitIndex)
                ...
                private:
                    ...
                    void setStateManager(std::shared_ptr <FollowerStateManager<S>> manager)
