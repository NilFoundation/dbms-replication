...
namespace nil::dbms::replication::log {
    ...
    public:
        ...
        [[nodiscard]] static auto construct(agency::log_plan_config config, std::unique_ptr<log_core> log_core,
        ...
        [[nodiscard]] auto is_leadership_established() const noexcept -> bool override;

        auto wait_for_leadership() -> WaitForFuture override;
        ...
        auto updateparticipants_config(
            std::shared_ptr<agency::participants_config const> const &config,
            std::function<std::shared_ptr<log::AbstractFollower>(ParticipantId const &)> const
    ...
    private:
        ...
        struct LocalFollower final : AbstractFollower {
            ...
            // lastIndex.
            LocalFollower(log_leader &self, logger_context logContext, std::unique_ptr<log_core> log_core,
            ...
            [[nodiscard]] auto appendEntries(AppendEntriesRequest request)
                -> nil::dbms::futures::Future<AppendEntriesResult> override;
        ...
        private:
            ...
            Guarded<std::unique_ptr<log_core>> _guardedlog_core;
        };

        struct PreparedAppendEntryRequest {
            PreparedAppendEntryRequest() = delete;
            PreparedAppendEntryRequest(std::shared_ptr<log_leader> const &log_leader,
        ...
        struct alignas(128) GuardedLeaderData {
            ...
            [[nodiscard]] auto prepareAppendEntries() -> std::vector<std::optional<PreparedAppendEntryRequest>>;

            [[nodiscard]] auto handleAppendEntriesResponse(FollowerInfo &follower, term_index_pair lastIndex,
                                                           log_index currentCommitIndex, log_index currentLITK,
                                                           log_term currentTerm, futures::Try<AppendEntriesResult> &&res,
            ...
            [[nodiscard]] auto updateCommitIndexLeader(log_index newIndex, std::shared_ptr<QuorumData> quorum)
                -> ResolvedPromiseSet;
        ...
        static void execute_append_entries_requests(std::vector<std::optional<PreparedAppendEntryRequest>> requests,
