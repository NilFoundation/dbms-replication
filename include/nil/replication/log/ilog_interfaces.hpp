        ...
        namespace replication {
            namespace log {
                ...
                struct ILogParticipant {
                    ...
                    resign() && -> std::tuple <std::unique_ptr<log_core>, deferred_action> = 0;
                    ...
                    [[nodiscard]] virtual auto getTerm() const

                    noexcept ->
                    std::optional<log_term>;

                    [[nodiscard]] virtual auto getCommitIndex() const

                    noexcept ->
                    log_index = 0;

                    [[nodiscard]] virtual auto copyin_memory_log() const -> in_memory_log = 0;
                ...
                struct ILogFollower : ILogParticipant, AbstractFollower {
                    ...
                    noexcept -> std::optional <ParticipantId> const & = 0;
                };
                ...
                struct Ilog_leader : ILogParticipant {
                    ...
                    virtual auto
                    insert(log_payload payload, bool waitForSync, DoNotTriggerAsyncReplication) -> log_index = 0;

                    virtual void triggerAsyncReplication() = 0;

                    [[nodiscard]] virtual auto is_leadership_established() const
