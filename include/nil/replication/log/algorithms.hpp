...
namespace nil::dbms::replication::algorithms {
    ...
    auto detectConflict(log::InMemoryLog const &log, term_index_pair prevLog) noexcept
    ...
    auto calculateCommitIndex(std::vector<participant_state> const &participants,
