...
namespace nil::dbms::replication_sdk::algorithms {
...
namespace nil::dbms::replication_sdk::replicated_log {
    ...
    private:
        ...
        struct alignas(128) guarded_leader_data {
            ...
            [[nodiscard]] auto handleAppendEntriesResponse(follower_info &follower, term_index_pair lastIndex,
                                                           log_index currentCommitIndex, log_index currentLITK, log_term currentTerm, futures::Try<append_entries_result> &&res,
