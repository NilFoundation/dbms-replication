...
#include <nil/replication_sdk/supervision/modify_context.hpp>
...
namespace nil::dbms::replication_sdk::replicated_log {
     ...
     *
     */
    using Action = std::variant<empty_action, no_action_possible_action, add_log_to_plan_action,
                                current_not_available_action, switch_leader_action, write_empty_term_action,
                                leader_election_action, update_participant_flags_action, add_participant_to_plan_action,
...
template<>
struct fmt::formatter<nil::dbms::replication_sdk::replicated_log::Action> : formatter<string_view> {
    // parse is inherited from formatter<string_view>.
    template<typename FormatContext>
    auto format(nil::dbms::replication_sdk::replicated_log::Action a, FormatContext &ctx) const {
