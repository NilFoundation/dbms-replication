...
#pragma GCC diagnostic pop
    ...
    struct append_entries_request {
        using EntryContainer = ::immer::flex_vector<in_memory_log_entry, nil::dbms::immer::dbms_memory_policy>;
        ...
        append_entries_request(log_term leaderTerm, ParticipantId leaderId, term_index_pair prevLogEntry,
                             log_index leaderCommit, log_index lowestIndexToKeep, message_id messageId, bool waitForSync,
                             EntryContainer entries);
...
namespace nil::dbms {
    template<>
    struct velocypack::Extractor<replication_sdk::replicated_log::message_id> {
        static auto extract(velocypack::Slice slice) -> replication_sdk::replicated_log::message_id {
            return replication_sdk::replicated_log::message_id {slice.getNumericValue<uint64_t>()};
        }
    };
}    // namespace nil::dbms
