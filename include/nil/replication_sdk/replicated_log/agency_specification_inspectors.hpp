...
namespace nil::dbms::replication_sdk::agency {
    ...
    auto inspect(Inspector &f, log_current_supervision::StatusMessage &x) {
        ...
        return f.variant(x)
            ...
            .alternatives(
                insp::type<log_current_supervision::target_leader_invalid>(
                ...
                insp::type<log_current_supervision::plan_not_available>(log_current_supervision::plan_not_available::code),
