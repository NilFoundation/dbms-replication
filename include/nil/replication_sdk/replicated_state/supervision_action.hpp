...
namespace nil::dbms::replication_sdk::replicated_state {
    ...
    using ActionContext =
        modify_context<replication_sdk::agency::log_target, agency::Plan, agency::Current::Supervision>;
    ...
    struct add_state_to_plan_action {
        replication_sdk::agency::log_target logTarget;
    ...
    auto executeAction(nil::dbms::replication_sdk::replicated_state::agency::State state,
                       std::optional<replication_sdk::agency::Log> log, Action &action) -> ActionContext;
