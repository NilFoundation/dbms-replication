...
namespace nil::dbms::replication_sdk::agency::methods {
    ...
    auto create_replicated_log_trx(nil::dbms::agency::envelope envelope, DatabaseID const &database,
                                   log_target const &spec)
        -> nil::dbms::agency::envelope;
    auto create_replicated_log(DatabaseID const &database, log_target const &spec) -> futures::Future<ResultT<uint64_t>>;
